...
class Settings(BaseSettings):
    ...
    Values are read from environment variables prefixed with ``HOMELAB_``
    (e.g. ``HOMELAB_DATA_DIR``) and optionally from a local ``.env`` file.
    """
    ...
    def database_url(self) -> str:
        ...
        return f"sqlite:///{self.data_dir}/homelab.db"
